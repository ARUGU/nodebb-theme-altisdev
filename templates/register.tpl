        ...
        <form class="form-horizontal" role="form" action="{config.relative_path}/register" method="post">
		    ...
		    <div class="form-group">
	                    <div class="input-group">
	                        ...
	                        <div class="fg-line">
	                            <input class="form-control" type="text" name="fullname" id="fullname" placeholder="Full Name" autocorrect="off" autocapitalize="off" />
	                        </div>
	                    </div>
			    <span class="register-feedback" id="fullname-notify"></span>
		    </div>
		    <div class="form-group">
	                    <div class="input-group">
		    ...
		    <div class="form-group">
	                    <div class="input-group">
	                        ...
	                        <div class="fg-line">
	                            <input class="form-control" type="number" name="phone" id="phone" placeholder="Mobile No" autocorrect="off" autocapitalize="off" />
	                        </div>
	                    </div>
			    <span class="register-feedback" id="phone-notify"></span>
		    </div>
                </div>
